...
public class VPN_top10domainTest {
    ...
    @DataProvider(name="countries") public Object[][] data(){
        return new Object[][]
                ...
                {{"Canada"},{"Germany"}, {"Netherlands"},{"Switzerland"},{"Sweden"}};
    ...
    public void setup()  {
        ...
        System.setProperty("webdriver.chrome.driver", "C:\\Users\\Rishabh Uniyal\\IdeaProjects\\Crawler\\drivers\\chromedriver.exe");
        String extension_Path = System.getProperty("user.dir");
        ChromeOptions chromeOptions = new ChromeOptions();
        chromeOptions.addExtensions(new File(extension_Path + "\\extensions\\Urban-Free-VPN-proxy-Unblocker---Best-VPN.crx"));
    ...
    public void vpnInit() throws InterruptedException, AWTException {
        ...
        String arr[] = {"United States"};
        //, "United Kingdom", "Canada", "Australia", "Germany", "Netherlands", "Switzerland", "Sweden"
        ...
        for (int i = 0; i < arr.length; i++) {
            ...
            //  Thread.sleep(5000);
            driver.get("https://top10.com/dna-testing/genealogy-comparison");
            Thread.sleep(2000);
            ...
            if(mostVisitedDNASitesSection.getText().contains("Our Top Choice")) {
            	if(mostVisitedDNASitesSection.getText().contains("MyHeritage")) {
            		System.out.println("Heritage is present as Our Top Choice");
            		 ...
            		 if(mostVisitedDNASitesSection.getText().contains("9.7")) {
            			 System.out.println("Heritage rating is 9.7");
                     }
            		 else {
            			 System.out.println("Heritage rating is not 9.7");
            			 //Screenshot
            		 }
                     if(mostVisitedDNASitesSection.getText().contains("96 million users globally")) {
                    	 System.out.println("Heritage has 96 million users globally");
                     }
                     else {
                     ...
                     if(mostVisitedDNASitesSection.getText().contains("Get Started")) {
                    	 System.out.println("Get Started link is present for Heritage");
                     }
                     else {
